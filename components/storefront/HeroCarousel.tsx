...
export function HeroCarousel({ banners }: HeroCarouselProps) {
  ...
  if (!banners || banners.length === 0) {
    return (
      <section className="w-full aspect-[4/3] sm:aspect-[16/9] lg:aspect-[2.5/1] relative flex items-center justify-center bg-gray-100">
        <Image
  ...
  return (
    <section className="w-full aspect-[4/3] sm:aspect-[16/9] lg:aspect-[2.5/1] relative flex items-center justify-center overflow-hidden bg-gray-100">
